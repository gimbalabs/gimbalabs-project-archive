# Tasks - BlockPrint x Gimbalabs to build BlockGov

This project has an associated Tasks database in Notion.

## Task Database Info

- **Database URL:** https://www.notion.so/2aa0db6d1d5d80a5ac20d8240ae6fb44
...
Tasks are filtered to show only those linked to the BlockGov project page. To view actual tasks, visit the Notion database URL above.
